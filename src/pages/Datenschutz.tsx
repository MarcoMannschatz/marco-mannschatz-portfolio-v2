        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">
              ...
              sind vor allem technische Daten (z.&nbsp;B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Die Erfassung
            ...
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">
              ...
              Zukunft widerrufen. Außerdem haben Sie das Recht, unter bestimmten Umständen die Einschränkung der Verarbeitung Ihrer
          ...
          <section>
            ...
            <p className="text-sm text-foreground/60 leading-relaxed">Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>

            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Externes Hosting</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
            ...
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">
              ...
              durch einen professionellen Anbieter (Art. 6 Abs. 1 lit. f DSGVO). Sofern eine entsprechende Einwilligung abgefragt wurde,
              erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die
            ...
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">Wir setzen folgende(n) Hoster ein:</p>
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">
              <strong>Vercel Inc.</strong>, 340 S Lemon Ave #4133, Walnut, CA 91789, USA
            </p>

            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Auftragsverarbeitung</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
              Wir haben einen Vertrag über Auftragsverarbeitung (AVV) zur Nutzung des oben genannten Dienstes geschlossen. Hierbei
          ...
          <section>
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Speicherdauer</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">
            ...
            <p className="text-sm text-foreground/60 leading-relaxed">
              ...
              erfolgt die Datenverarbeitung zusätzlich auf Grundlage von § 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.
              Sind Ihre Daten zur Vertragserfüllung oder zur Durchführung vorvertraglicher Maßnahmen erforderlich, verarbeiten wir Ihre
              Daten auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten, sofern diese zur Erfüllung
              einer rechtlichen Verpflichtung erforderlich sind, auf Grundlage von Art. 6 Abs. 1 lit. c DSGVO. Die Datenverarbeitung
              kann ferner auf Grundlage unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen. Über die jeweils im
              Einzelfall einschlägigen Rechtsgrundlagen wird in den folgenden Absätzen dieser Datenschutzerklärung informiert.
            </p>

            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Empfänger von personenbezogenen Daten</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
              Im Rahmen unserer Geschäftstätigkeit arbeiten wir mit verschiedenen externen Stellen zusammen. Dabei ist teilweise auch
              eine Übermittlung von personenbezogenen Daten an diese externen Stellen erforderlich. Wir geben personenbezogene Daten nur
              dann an externe Stellen weiter, wenn dies im Rahmen einer Vertragserfüllung erforderlich ist, wenn wir gesetzlich hierzu
              verpflichtet sind (z.&nbsp;B. Weitergabe von Daten an Steuerbehörden), wenn wir ein berechtigtes Interesse nach Art. 6
              Abs. 1 lit. f DSGVO an der Weitergabe haben oder wenn eine sonstige Rechtsgrundlage die Datenweitergabe erlaubt. Beim
              Einsatz von Auftragsverarbeitern geben wir personenbezogene Daten unserer Kunden nur auf Grundlage eines gültigen Vertrags
              über Auftragsverarbeitung weiter. Im Falle einer gemeinsamen Verarbeitung wird ein Vertrag über gemeinsame Verarbeitung
              geschlossen.
            </p>
            ...
            <p className="text-sm text-foreground/60 leading-relaxed">
              ...
              GRÜNDEN, DIE SICH AUS IHRER BESONDEREN SITUATION ERGEBEN, GEGEN DIE VERARBEITUNG IHRER PERSONENBEZOGENEN DATEN
            ...
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">
              ...
              DIES GILT AUCH FÜR DAS PROFILING, SOWEIT ES MIT SOLCHER DIREKTWERBUNG IN VERBINDUNG STEHT. WENN SIE WIDERSPRECHEN, WERDEN
              IHRE PERSONENBEZOGENEN DATEN ANSCHLIESSEND NICHT MEHR ZUM ZWECKE DER DIREKTWERBUNG VERWENDET (WIDERSPRUCH NACH ART. 21
              ABS. 2 DSGVO).
            </p>
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Auskunft, Berichtigung und Löschung</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Recht auf Einschränkung der Verarbeitung</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-foreground/60 leading-relaxed mt-2">
              <li>
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">SSL- bzw. TLS-Verschlüsselung</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Widerspruch gegen Werbe-E-Mails</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm text-foreground/60 leading-relaxed mt-2">
            ...
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">Eine Zusammenführung dieser Daten mit anderen Datenquellen wird nicht vorgenommen.</p>
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Schriftarten</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Kontaktformular</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
            ...
            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Kontaktformular-Versand über Brevo</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
              Für den Versand der über das Kontaktformular eingehenden Nachrichten nutzen wir den Dienst Brevo (Sendinblue SAS, 7 Rue
              de Madrid, 75008 Paris, Frankreich). Dabei werden die von Ihnen im Formular eingegebenen Daten (Name, E-Mail-Adresse,
              Nachrichtentext) zum Zwecke der E-Mail-Zustellung an uns von Brevo verarbeitet.
            </p>
            <p className="text-sm text-foreground/60 leading-relaxed mt-2">
              Die Verarbeitung erfolgt auf Grundlage unseres berechtigten Interesses an einer zuverlässigen und effektiven Bearbeitung
              Ihrer Anfrage (Art. 6 Abs. 1 lit. f DSGVO). Brevo ist ein EU-Anbieter mit Serverstandort in Frankreich.
            </p>

            <h3 className="text-sm font-bold uppercase tracking-wider mt-4 mb-2">Anfrage per E-Mail, Telefon oder Telefax</h3>
            <p className="text-sm text-foreground/60 leading-relaxed">
